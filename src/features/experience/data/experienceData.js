const experienceData = [
  {
    ...
    role: 'Graphic Designer & Visual Branding',
    desc: 'Merancang Identitas Visual (Brand Identity), mendesain konten media sosial (Instagram feed/story), banner iklan digital, brosur, flyer, spanduk, katalog, hingga antarmuka website.'
  },
  {
    icon: 'menu_book',
    title: 'LKP Mahasinu',
    period: '2023 - 2024',
    role: 'Creative & Layout Designer',
